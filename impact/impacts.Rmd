...
histogram and statistics for latitudinal pattenrns
```{r}
...
habitat_compare
ggsave(habitat_compare, filename ="impact/figs/georegion_pressure_cumulative_impact.png", width=8, height =4, units = c("in"))
...
cumulative impact: country EEZ summaries (don't end up uisng this)
```{r}
