...
diff_impact(raster=ssp2_med, lowerscale = -0.1, upperscale = 1.1, saveName="sspp245_change.tif")
```
...
eez <- read_csv(here("impact/data/country_eez_impact.csv"))

impact_country <- rbind(coast, eez) %>%
...
write_csv(coastal_compare, here("impact/data/country_eez_cumulative_impact.csv"))


coastal_compare <- read_csv(here("impact/data/country_eez_cumulative_impact.csv")) 
