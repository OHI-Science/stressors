...
#  global(offshore_gdp_km2, "sum", na.rm=TRUE)
...
v1 <- terra::ifel(is.na(offshore_gdp_km2_NAs), offshore_gdp_km2, offshore_gdp_km2_NAs)  
#global(v1, "sum", na.rm=TRUE)  
v1_NA <- ifel(v1==0, NA, v1) 
terra::writeRaster(v1, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v1_%s_%s.tif", scen, time_frame), overwrite=TRUE)


# layer 2 estimated
prev2 <-   terra::focal(v1, w=3, fun=mean, na.rm=TRUE)  
#global(prev2, "sum", na.rm=TRUE)
  
v2 <- terra::ifel(is.na(v1_NA), prev2, v1_NA)  
#global(v2, "sum", na.rm=TRUE)  
v2_NA <- ifel(v2==0, NA, v2) 
terra::writeRaster(v2, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v2_%s_%s.tif", scen, time_frame), overwrite=TRUE)


# layer 3 estimated
prev3 <-   terra::focal(v2, w=3, fun=mean, na.rm=TRUE)  
global(prev3, "sum", na.rm=TRUE)
  
v3 <- terra::ifel(is.na(v2_NA), prev3, v2_NA)  
#global(v3, "sum", na.rm=TRUE)  
terra::writeRaster(v3, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v3_%s_%s.tif", scen, time_frame), overwrite=TRUE)
...
terra::writeRaster(gdp_per_km2, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2_%s.tif", name), overwrite=TRUE)
...
#global(v1, "sum", na.rm=TRUE)  
v1_NA <- ifel(v1==0, NA, v1) 
terra::writeRaster(v1, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v1_%s.tif", name), overwrite=TRUE)
...
#global(v2, "sum", na.rm=TRUE)  
v2_NA <- ifel(v2==0, NA, v2) 
terra::writeRaster(v2, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v2_%s.tif", name), overwrite=TRUE)
...
v3 <- terra::ifel(is.na(v2_NA), prev3, v2_NA)  
#global(v3, "sum", na.rm=TRUE)  
terra::writeRaster(v3, sprintf("/home/shares/ohi/stressors_2021/_dataprep/gdp/gdp-per-km2-extended_v3_%s.tif", name), overwrite=TRUE)
