...
files2scale <- list.files("/home/shares/ohi/stressors_2021/_raw_data/biooracle_oxygen", pattern = "depthmean", full=TRUE)

for(file2scale in files2scale){ # file2scale <- files2scale[1]
historic_rast <- rast("/home/shares/ohi/stressors_2021/_raw_data/biooracle_oxygen/o2-depthmean_hist_hist.tif")
...
# surface water
files2scale <- list.files("/home/shares/ohi/stressors_2021/_raw_data/biooracle_oxygen", pattern = "depthsurf", full=TRUE)

for(file2scale in files2scale){ # file2scale <- files2scale[1]
historic_rast <- rast("/home/shares/ohi/stressors_2021/_raw_data/biooracle_oxygen/o2-depthsurf_hist_hist.tif")
stress_rescale <- o2rescale(fp_current = file2scale, 
          historic = historic_rast)
writeRaster(stress_rescale, file.path("/home/shares/ohi/stressors_2021/_dataprep/oxygen/rescaled", basename(file2scale)), overwrite=TRUE)
}
