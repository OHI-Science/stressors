...
boundary_mask_mol <- extend(boundary_mask_mol, ext(rast_base_10km_file), fill=NA)
boundary_mask_mol <- resample(boundary_mask_mol, rast_base_10km_file, method="near")
