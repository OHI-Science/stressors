...
yr_range <- data.frame(period = rep(c("current", "near", "medium", "long"), each=20),
                       year = c(2001:2020, 2021:2040, 2041:2060, 2081:2100))
...
## current
year_list <- list.files("/home/shares/ohi/stressors_2021/_dataprep/SST/year_exceed_two_sd", pattern = paste(yr_range$year[yr_range$period=="current"], collapse="|"), full=TRUE)
year_list <- grep("hist|ssp245", year_list, value=TRUE)
...
writeRaster(prop_yr_exceed, "/home/shares/ohi/stressors_2021/_dataprep/SST/pressure_twoSD/sst-extreme_NA_current.tif", format='GTiff', overwrite=TRUE)


## scenarios

for(period in c("near","medium", "long")){
  # period = "near"
...
writeRaster(r, filename = sprintf("/home/shares/ohi/stressors_2021/_dataprep/SST/final_extreme/%s", basename), overwrite = TRUE)
