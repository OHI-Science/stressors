...
# lights
light <- rast("/Users/frazier/Desktop/gdp_wang/lights/prep/light_current_2016_2020.tif")
...
terra::writeRaster(total, sprintf("/Users/frazier/Desktop/gdp_wang/population/pop_prep/%s", saveName), overwrite=TRUE)
}
...
pop_t1 <- rast("/Users/frazier/Desktop/gdp_wang/population/pop_prep/pop_time1.tif") * coastal
pop_t2 <- rast("/Users/frazier/Desktop/gdp_wang/population/pop_prep/pop_time2.tif") * coastal
...
# saveRDS(rf2, "/Users/frazier/Desktop/gdp_wang/rf_model.rds")
