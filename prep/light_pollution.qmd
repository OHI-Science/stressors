...
for(raster_file in raster_list){ # raster_file = raster_list[[1]]
  ...
  crs(rescaled_raster_data) <- crs(rast_base_10km_file)
  
  writeRaster(rescaled_raster_data, sprintf("/home/shares/ohi/stressors_2021/_dataprep/light/rescale/%s", saveName))
}
