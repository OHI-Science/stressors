...
#cellSize(shoreline_density_km2, unit="km")
  ...
  offshore_density_km2 <- ifel(is.na(shoreline_density_km2), 0, shoreline_density_km2) 

offshore_density_km2 <-   terra::focal(offshore_density_km2, w=3, fun=mean, na.rm=TRUE)
...
test1 <- terra::ifel(rescale_raster_coast >= 10.55184, 1, NA)
plot(as.points(test1), col="red")
plot(ocean_moll_sf, add=TRUE, color=NA)

test2 <- terra::ifel(rescale_raster_coast >= 9.24, 1, NA)
