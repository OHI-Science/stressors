...
tmp <- rast("/home/shares/ohi/stressors_2021/_dataprep/nutrients/output/N_plume/SSP1_current_short_joined.tif")
plot(log(tmp+1))

global(tmp, "sum")

sf_tmp <- st_read("/home/shares/ohi/stressors_2021/_dataprep/nutrients/plume_data/SSP1_current_short.shp")
sum(sf_tmp$effluent)
```
