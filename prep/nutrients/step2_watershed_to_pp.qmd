...
tmp <- terra::rast("/home/shares/ohi/stressors_2021/_dataprep/nutrients/output/N_plume/SSP5_near-term_joined.tif")
#terra::plot(log(tmp+1))

raster::cellStats(raster::raster(tmp), "sum", na.rm=TRUE)

sf_tmp <- sf::st_read("/home/shares/ohi/stressors_2021/_dataprep/nutrients/plume_data/SSP5_current.shp")
sum(sf_tmp$effluent)
