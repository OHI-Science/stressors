...
future_stack <- "/home/shares/ohi/stressors_2021/_raw_data/oa_arag_noaa_jiang/nc/median/Aragonite_median_ssp119.nc"
...
raster_stack_future <- terra::rast(future_stack)
  raster_stack_future <- raster_stack_future[[grep("aragonite", names(raster_stack_future))]]
  ...
  oa_predict <- terra::app(c(future_rast, hist_rast), mean)
...
terra::writeRaster(oa_mask, filename=sprintf("/home/shares/ohi/stressors_2021/_dataprep/oa/oa_current.tif",
              saveName, select_time_frame), overwrite=TRUE)
...
ggplot() +
  geom_spatraster(data = terra::rast(rast_list[10])) +
